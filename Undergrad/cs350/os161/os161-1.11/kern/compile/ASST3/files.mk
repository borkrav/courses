...
smartarray.o: ${S}/userprog/smartarray.c
	${COMPILE.c} ${S}/userprog/smartarray.c
SRCS+=${S}/userprog/smartarray.c
OBJS+=smartarray.o

processes.o: ${S}/userprog/processes.c
	${COMPILE.c} ${S}/userprog/processes.c
SRCS+=${S}/userprog/processes.c
OBJS+=processes.o
...
vmstats.o: ${S}/vm/vmstats.c
	${COMPILE.c} ${S}/vm/vmstats.c
SRCS+=${S}/vm/vmstats.c
OBJS+=vmstats.o
