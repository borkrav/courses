...
int main(int argc, char *argv[]) {
  ...
  argTypes5[0] = (1 << ARG_OUTPUT) | (ARG_CHAR << 16) | 10;
  ...
  */
  ...
  ret = rpcRegister("f0", argTypes0, *f0_Skel);
	cout << ret << endl;
  ret = rpcRegister("f1", argTypes1, *f1_Skel);
	cout << ret << endl;
  ret = rpcRegister("f2", argTypes2, *f2_Skel);
	cout << ret << endl;
  ret = rpcRegister("f3", argTypes3, *f3_Skel);
	cout << ret << endl;
  ret = rpcRegister("f4", argTypes4, *f4_Skel);
	cout << ret << endl;
