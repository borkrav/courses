...
mat1 = gr.phongMat({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 25, 0.8, 5)
mat2 = gr.phongMat({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 25, 0.8, 10)
mat3 = gr.phongMat({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 25, 0.8, 20)
...
gr.render(scene_root, 'glossy.png', 500, 500,
	  {0, 0, 20}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.3, 0.3, 0.3}, {white_light}, 1, 0, 4, {1, 15, 0})
