...
sphere2 = gr.nh_sphere('',{0,-4.4,2},0.5)
sphere2:set_material(red)
scene_root:add_child(sphere2)

sphere3 = gr.nh_sphere('',{1,-4.4,5},0.5)
sphere3:set_material(green)
scene_root:add_child(sphere3)

sphere4 = gr.nh_sphere('',{-1,-4.4,8},0.5)
...
gr.render(scene_root, 'DOF.png', 500, 500,
	  ...
	  {0.3, 0.3, 0.3}, {white_light}, 1, 0, 0, {1, 15, 5})
