...
sphere2 = gr.nh_sphere('',{0,-4,5},1)
sphere2:set_material(glass1)
scene_root:add_child(sphere2)

sphere3 = gr.nh_sphere('',{0,-1,5},1)
sphere3:set_material(glass2)
scene_root:add_child(sphere3)

sphere4 = gr.nh_sphere('',{0,2,5},1)
sphere4:set_material(glass3)
scene_root:add_child(sphere4)


cyl1 = gr.cyllinder('')
cyl1:translate(0,-5,3.5)
...
gr.render(scene_root, 'refrTranslusency.png', 500, 500,
	  {0, 0, 20}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.3, 0.3, 0.3}, {white_light}, 1, 4, 4, {1, 15, 0})
